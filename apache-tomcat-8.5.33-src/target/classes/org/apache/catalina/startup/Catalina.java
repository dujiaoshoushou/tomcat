...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        /**
         * 创建server实例
         * Catalina中Server的默认实现类为StandardServer，但是可以通过className指定自己的实现类。
         * Digester创建Server实例后，设置Server的相关属性，并将其设置到Catalina对象中（调用setServer）
         */
        ...
        /**
         * 为Server添加Service实例。
         * catalina默认的是StandardService
         * 也可通过className指定自己的实现Service
         * 创建完成后，通过addService方法添加到Server实例中。
         */
        ...
        //Executor
        /**
         * 为Service添加Executor实例，
         * catalina默认的是StandardThreadExecutor
         * 也可以通过className指定自己实现的类
         * 通过addExecutor方法将Excecutor添加到Service实例中。
         */
        ...
        /**
         * 为Service添加Connector实例。同时设置相关属性
         * 将executor和sslImplementationName属性排除
         */
        ...
        digester.addSetNext("Server/Service/Connector/SSLHostConfig/OpenSSLConf/OpenSSLConfCmd",
                ...
                "org.apache.tomcat.util.net.openssl.OpenSSLConfCmd");
        /**
         * 为Connector添加生命周期监听器，catalina没有指定具体的Connector监听器
         */
